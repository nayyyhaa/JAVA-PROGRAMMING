...
List<String> l=Arrays.asList(str1);
Set<String> ll=new TreeSet<String>(l);
System.out.println("Number of unique words "+ll.size()+"\nThe words are" );
int i=1;
for(String lll:ll){
System.out.println((i)+". "+lll.toLowerCase());
i++;
}
}
}
